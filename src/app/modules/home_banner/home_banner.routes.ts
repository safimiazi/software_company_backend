...
router.post("/post_home_banner_data", uploadService.single("image"),   configurableCompression("jpeg", 60),validateRequest(HomeBannerValidationSchema), homeBannerControllers.admin_post_home_banner )
